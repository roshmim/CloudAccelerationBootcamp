...
out.write("\r\n\r\n\r\n");
{
    Object var_includedresult4 = renderContext.call("include", "/libs/cq/cloudserviceconfigs/components/servicelibs/servicelibs.jsp", obj());
    out.write(renderContext.getObjectModel().toString(var_includedresult4));
}
out.write("\r\n\r\n\r\n");
{
    Object var_includedresult7 = renderContext.call("include", "/libs/wcm/core/components/init/init.jsp", obj());
    out.write(renderContext.getObjectModel().toString(var_includedresult7));
}
